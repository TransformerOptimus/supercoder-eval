...
\thanks{Code and data: \url{https://github.com/TransformerOptimus/supercoder-eval}}}
...
% \input{sections/08_appendices}  % kept out of build; content lives in released artifacts
